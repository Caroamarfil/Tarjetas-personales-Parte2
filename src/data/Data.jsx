...
    }
  ...
  //Datos y estilos de Caro
  {
    ...
    githubClass: 'caro-btn ',
    linkedinClass: 'caro-btn ',
    githubIcon: 'bi bi-github',
    linkedinIcon: 'bi bi-linkedin',
  ...
  // Datos y estilos de Maxi
  {
    ...
    imgClass: 'rounded-circle mx-auto mb-4 border border-3 border-white shadow maxi-photo',
    imgStyle: {
      width: '150px',
      height: '150px',
      objectFit: 'cover',
